...
// C2 (QA 2026-09-18): --include-end-of-life mixed tombstones into the list with
// no way to tell them apart. With the flag, the table gains a Lifecycle column.
...
// The description is cut to 60 characters for the table. Cutting by bytes split
// multi-byte characters, which printed as a broken glyph.
